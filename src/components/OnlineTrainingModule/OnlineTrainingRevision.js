            ...
            {isSidebarVisible && (
                <div className="sidebar-um">
                    ...
                    <div className="sidebar-logo-dm-fi">
                        <p className="logo-text-dm-fi">{"Under Revision Courses"}</p>
                    </div>
                </div>
            )}
            ...
            <div className="main-box-gen-info">
                ...
                <div className="table-flameproof-card">
                    <div className="flameproof-table-header-label-wrapper">
                        <label className="risk-control-label">{"Under Revision Courses"}</label>
...
export default OnlineTrainingRevision;
