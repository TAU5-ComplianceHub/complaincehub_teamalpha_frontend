...
const API_BASE = `${process.env.REACT_APP_URL}/api/visitorDrafts`;
const EDITOR_ROUTE = (draftId) => `/FrontendDMS/inductionCreation/${draftId}`;
const PREVIEW_ROUTE = (draftId, version) => `/FrontendDMS/tmsDraftVersionPreview/induction/${draftId}/${version}`;

const InductionVersionHistoryPage = () => {
    ...
    const loadVersions = async () => {
        ...
        try {
            ...
            console.error("Failed to load induction version history:", error);
    ...
    const restoreVersion = async (item) => {
        ...
        try {
            ...
            console.error("Failed to restore induction version:", error);
...
export default InductionVersionHistoryPage;
